...
import login from "../Images/49093.jpg";
...
const Login = () => {
  ...
  return (
    ...
    <Navbar/>
    <div className="grid sm:grid-cols-2 rounded-lg bg-gradient-to-br from-blue-700 to-cyan-500  mx-20 my-8">
    <div className=" roundded-md m-11 hidden sm:block">
       <img src={login} className="rounded-md "/>
    </div>
